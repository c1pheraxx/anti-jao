...
| Popup | Configurações | Estatísticas |
|-------|--------------|--------------|
| *(adicione screenshot aqui)* | *(adicione screenshot aqui)* | *(adicione screenshot aqui)* |

> 💡 **Dica:** Adicione screenshots na pasta `screenshots/` e atualize esta tabela.
...
[⭐ Star este repo](https://github.com/seu-usuario/anti-jao) · [🐛 Reportar bug](../../issues) · [💡 Sugerir funcionalidade](../../issues)
